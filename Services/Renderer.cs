...
internal sealed class Renderer : IDisposable
{
    ...
    public static RectangleF CloseButtonRect(float sx, float sy, float sw, float sh)
    {
        const float sz = 22f;
        return new RectangleF(sx + sw - sz, sy, sz, sz);
    }
    ...
    private void DrawArrow(float opacity)
    {
        ...
        var p3 = new Vector2(cx + 3f, cy + 6f);
    ...
    private void DrawDotGrid(Camera camera, float opacity)
    {
        ...
        float spacing = Math.Clamp(_theme.DotSpacing, 40, 200);
    ...
    public RectangleF DrawToggleRect => new(18f, _height - _safeBottom - BtnSize - 12f, BtnSize, BtnSize);
    ...
    private ID2D1Image? TryGrabBlur()
    {
        ...
        try
        {
            ...
            _toolGrab.CopyFromRenderTarget(new Point(0, 0), _d2d,
